...
import logica.SendMail;
import logica.SerialSenha;
import logica.ThreadCompromisso;
import logica.Uteis;
import models.AnotacoesModel;
import models.CompromissosModel;
...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("http://www.nortev.net63.net/");

        jLabel6.setFont(new java.awt.Font("sansserif", 1, 14));
        jLabel6.setText("Nortev Solutions");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(abaPainel, javax.swing.GroupLayout.DEFAULT_SIZE, 924, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void arrumarConfigs() {
        ...
        trayIcon = new TrayIcon(createImage("/imagens/diario.png", "Icone tray"), "Agenda Nortev", null);
